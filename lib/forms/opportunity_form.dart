...
class OpportunityForm extends StatelessWidget {
  ...
  const OpportunityForm({Key? key, required this.formArguments})
      : super(key: key);
                        ...
                        child: GridView.count(
                            ...
                            children: <Widget>[
                              ...
                              TextFormField(
                                key: Key('NextStep'),
                                decoration:
                                    InputDecoration(labelText: 'Next step'),
                              ...
                              ElevatedButton(
                                  ...
                                  onPressed: () {
                                    if (_formKey.currentState!.validate() &&
                                      ...
                                      print(
                                          "selected lead: ${updatedOpportunity.leadPartyId}");
