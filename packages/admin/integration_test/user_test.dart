...
// this test requires company test to run first
  ...
  testWidgets('''GrowERP user test''', (tester) async {
    ...
    await UserTest.addAdministrators(tester);
