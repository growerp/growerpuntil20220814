    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (kReleaseMode) {
          ...
          print(
              "=== New prod ip: $ip , chat: $chat company: $singleCompany Updated!");
        } else {
          GlobalConfiguration().updateValue("databaseUrlDebug", ip);
          GlobalConfiguration().updateValue("chatUrlDebug", chat);
          print(
              "=== New DEBUG ip: $ip , chat: $chat company: $singleCompany Updated!");
        }
      }
    } catch (error) {
